...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.undoLastUnpushedCommit.menuItem': '還原最後一次未推送的提交',
  'gitView.undoLastUnpushedCommit.title': '還原最後一次未推送的提交',
  'gitView.undoLastUnpushedCommit.description': '這會移除最後一次未推送的提交，其變更將保持暫存狀態。',
  'gitView.undoLastUnpushedCommit.confirm': '還原提交',
  'gitView.undoLastUnpushedCommit.success': '已還原最後一次未推送的提交',
  ...
  'chat.workStatus.lsp.connected': '已連線',
  'chat.workStatus.lsp.error': '錯誤',
  ...
  'chat.workStatus.section.skills': '技能',
