...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.undoLastUnpushedCommit.menuItem': '最後の未プッシュコミットを取り消す',
  'gitView.undoLastUnpushedCommit.title': '最後の未プッシュコミットを取り消す',
  'gitView.undoLastUnpushedCommit.description': '最後の未プッシュコミットを削除します。変更はステージ済みのまま残ります。',
  'gitView.undoLastUnpushedCommit.confirm': 'コミットを取り消す',
  'gitView.undoLastUnpushedCommit.success': '最後の未プッシュコミットを取り消しました',
  ...
  'chat.workStatus.lsp.connected': '接続済み',
  'chat.workStatus.lsp.error': 'エラー',
  ...
  'chat.workStatus.section.skills': 'スキル',
