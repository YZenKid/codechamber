...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.undoLastUnpushedCommit.menuItem': '撤销最后一次未推送的提交',
  'gitView.undoLastUnpushedCommit.title': '撤销最后一次未推送的提交',
  'gitView.undoLastUnpushedCommit.description': '这会移除最后一次未推送的提交，其更改将保持暂存状态。',
  'gitView.undoLastUnpushedCommit.confirm': '撤销提交',
  'gitView.undoLastUnpushedCommit.success': '已撤销最后一次未推送的提交',
  ...
  'chat.workStatus.lsp.connected': '已连接',
  'chat.workStatus.lsp.error': '错误',
