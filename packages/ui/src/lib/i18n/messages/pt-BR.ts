...
export const dict: Record<I18nKey, string> = {
  ...
  "gitView.undoLastUnpushedCommit.menuItem": "Desfazer último commit não enviado",
  "gitView.undoLastUnpushedCommit.title": "Desfazer último commit não enviado",
  "gitView.undoLastUnpushedCommit.description": "Isso remove o último commit não enviado. As alterações dele permanecerão no stage.",
  "gitView.undoLastUnpushedCommit.confirm": "Desfazer commit",
  "gitView.undoLastUnpushedCommit.success": "Último commit não enviado desfeito",
  ...
  'chat.workStatus.lsp.error': 'Erro',
