...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.undoLastUnpushedCommit.menuItem': '마지막 푸시하지 않은 커밋 되돌리기',
  'gitView.undoLastUnpushedCommit.title': '마지막 푸시하지 않은 커밋 되돌리기',
  'gitView.undoLastUnpushedCommit.description': '마지막으로 푸시하지 않은 커밋을 제거합니다. 변경 사항은 스테이징된 상태로 유지됩니다.',
  'gitView.undoLastUnpushedCommit.confirm': '커밋 되돌리기',
  'gitView.undoLastUnpushedCommit.success': '마지막 푸시하지 않은 커밋을 되돌렸습니다',
  ...
  'chat.workStatus.lsp.connected': '연결됨',
  'chat.workStatus.lsp.error': '오류',
  ...
  'chat.workStatus.section.skills': '스킬',
