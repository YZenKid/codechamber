...
import { canShowSessionWorktreeMenu, getSessionWorktreeMenuDisabled, nodeContainsSessionId, nodeHasPinnedMembershipChange, resolveSessionPrLookupKey, resolveTooltipBranchLabel, selectFormBadgeSessionScopes, selectRowBadgeVisibilityClass, selectSessionRowStatusMarker } from './sessionNodeItemUtils';
...
function SessionNodeItemComponent(props: SessionNodeItemProps): React.ReactNode {
  ...
  // A running subagent keeps the row's marker lit after the parent's own turn
  // settled. The elapsed counter stays parent-only.
  const {
    isBusy,
    showStatusMarker,
